            ...
            <div class="card-body">
                ...
                <form action="{{ route('reservation.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <input type="text" class="form-control" name="reservation_number" placeholder="Masukkan No Reservasi" value="{{ $reservation_number ?? '' }}" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Nama Tamu *</label>
                        <input type="text" class="form-control" name="guest_name" placeholder="Masukkan Nama Tamu">
                    </div>
                    <div class="mb-3">
